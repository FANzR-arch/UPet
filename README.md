...
**双击即出宠物**——内置了 Codex 官方默认宠物，无需任何配置。
...
| `assets/codex-default.webp` | 内置默认宠物（Codex 官方默认宠物，来自 OpenAI CDN） |
...
```
python -m PyInstaller --noconfirm --onefile --windowed --name UPet --icon icon.ico --add-data "assets\codex-default.webp;assets" --exclude-module numpy --exclude-module charset_normalizer upet.py
```
