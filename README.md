...
```
python -m PyInstaller --noconfirm --onefile --windowed --name UPet --icon icon.ico --add-data "spritesheet.webp;." --exclude-module numpy --exclude-module charset_normalizer upet.py
```
